...
export default function JournalEntryScreen() {
  ...
  const remaining = MAX_JOURNAL_LENGTH - journalText.length;
  const isOverLimit = remaining < 0;
  
  const categoryColors = NOTEBOOK_CATEGORY_COLORS[theme]['journal'];
    ...
    <View style={[styles.container, { backgroundColor: colors.background }]}>
          ...
          <View style={styles.inputSection}>
            ...
            >
              ...
              <TextInput
                ...
                maxLength={MAX_JOURNAL_LENGTH + 50}
              />
            </Pressable>
      ...
      <View style={[styles.footer, { backgroundColor: colors.background, paddingBottom: insets.bottom + SPACING.md }]}>
        <TouchableOpacity
          style={[
            styles.saveButton, 
            { backgroundColor: (isOverLimit || !journalText.trim()) ? colors.surfaceAlt : '#10B981' }
          ]}
          onPress={handleSave}
